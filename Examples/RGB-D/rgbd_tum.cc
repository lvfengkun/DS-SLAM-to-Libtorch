...
int main(int argc, char **argv)
{
    ...
    string strAssociationFilename = "data/rgbd_dataset_freiburg3_walking_rpy/associations.txt";//string(argv[4])
    ...
    string img_path="data/rgbd_dataset_freiburg3_walking_rpy";
